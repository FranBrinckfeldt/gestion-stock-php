...
<div class="mb-5 mt-5 text-center">
    ...
    <a type="button" href="{{ url('products/create') }}" class="btn btn-primary btn-lg">Nuevo producto</a>
</div>
...
<table class="table">
    ...
    <tbody>
        <tr>
            ...
            <td>$1.500</td>
            <td>
                <a type="button" href="{{ url('products/edit/1') }}" class="btn btn-warning btn-sm">Editar</a>
        ...
        <tr>
            ...
            <td>$3.000</td>
            <td>
                <a type="button" href="{{ url('products/edit/2') }}" class="btn btn-warning btn-sm">Editar</a>
                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
                    Eliminar
                </button>
            </td>
        ...
        <tr>
            ...
            <td>$6.000</td>
            <td>
                <a type="button" href="{{ url('products/edit/3') }}" class="btn btn-warning btn-sm">Editar</a>
                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
                    Eliminar
                </button>
            </td>
